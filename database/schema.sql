...
INSERT INTO orders (product_id, order_type, quantity, customer_supplier_name, total_amount, order_date, staff_id) VALUES
-- Recent Sales (January 2025)
(1, 'Sale', 2, 'Mohammed Al-Khateeb', 2598.00, '2025-01-03', 'STAFF001'),
(7, 'Sale', 1, 'Layla Hussein', 1199.00, '2025-01-03', 'STAFF002'),
(12, 'Sale', 3, 'Mobile Solutions LLC', 1347.00, '2025-01-03', 'STAFF001'),
(19, 'Sale', 10, 'Tech Accessories Store', 80.00, '2025-01-03', 'STAFF003'),
(28, 'Sale', 5, 'Ahmad Saleh', 95.00, '2025-01-02', 'STAFF002'),
(40, 'Sale', 2, 'Sara Mahmoud', 498.00, '2025-01-02', 'STAFF001'),
(4, 'Sale', 5, 'University Bookstore', 3995.00, '2025-01-02', 'STAFF003'),
(50, 'Sale', 3, 'Hala Rashid', 747.00, '2025-01-01', 'STAFF001'),
(24, 'Sale', 8, 'Phone Repair Center', 176.00, '2025-01-01', 'STAFF002'),
(35, 'Sale', 15, 'Electronics Wholesale', 1185.00, '2025-01-01', 'STAFF003'),

-- December 2024 Sales
(2, 'Sale', 3, 'Corporate Gift Order', 2997.00, '2024-12-31', 'STAFF001'),
(13, 'Sale', 4, 'Retail Electronics Chain', 1796.00, '2024-12-30', 'STAFF002'),
(20, 'Sale', 20, 'Case Distributor', 500.00, '2024-12-29', 'STAFF003'),
(32, 'Sale', 12, 'Accessories Boutique', 336.00, '2024-12-28', 'STAFF001'),
(45, 'Sale', 2, 'Waleed Othman', 798.00, '2024-12-27', 'STAFF002'),
(54, 'Sale', 6, 'Smart Gadgets Store', 210.00, '2024-12-26', 'STAFF003'),
(9, 'Sale', 8, 'Mobile Retailer Group', 6392.00, '2024-12-25', 'STAFF001'),

-- Recent Purchases (Stock Replenishment)
(5, 'Purchase', 30, 'Apple Official Distributor', 20970.00, '2025-01-02', 'ADMIN001'),
(8, 'Purchase', 40, 'Samsung Middle East', 39960.00, '2025-01-02', 'ADMIN001'),
(14, 'Purchase', 25, 'Xiaomi Regional Supplier', 16225.00, '2025-01-01', 'ADMIN002'),
(30, 'Purchase', 100, 'Cable Solutions Wholesale', 1900.00, '2025-01-01', 'ADMIN001'),
(40, 'Purchase', 50, 'Audio Equipment Distributor', 12450.00, '2024-12-31', 'ADMIN002'),
(19, 'Purchase', 200, 'Phone Accessories Supplier', 1600.00, '2024-12-31', 'ADMIN001'),
(26, 'Purchase', 150, 'Screen Protection Wholesale', 1800.00, '2024-12-30', 'ADMIN001'),

-- December Purchases
(1, 'Purchase', 50, 'Apple Official Distributor', 64950.00, '2024-12-20', 'ADMIN001'),
(7, 'Purchase', 30, 'Samsung Middle East', 35970.00, '2024-12-21', 'ADMIN001'),
(36, 'Purchase', 100, 'Power Solutions International', 2500.00, '2024-12-22', 'ADMIN002'),
(43, 'Purchase', 80, 'Audio Equipment Distributor', 19920.00, '2024-12-23', 'ADMIN001'),
(51, 'Purchase', 40, 'Wearables Technology Supplier', 17160.00, '2024-12-24', 'ADMIN002'),
(55, 'Purchase', 60, 'Storage Media Wholesale', 2100.00, '2024-12-25', 'ADMIN001'),
(62, 'Purchase', 150, 'Accessories Manufacturing Co', 1200.00, '2024-12-26', 'ADMIN002');
